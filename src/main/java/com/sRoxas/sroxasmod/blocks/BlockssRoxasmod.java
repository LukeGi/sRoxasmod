...
public class BlockssRoxasmod
{
    public static void init()
    {
        ...
        BambooPlanks = new BlockMod(Material.wood, Names.Blocks.BAMBOO_PLANKS, 1.5f, 3f);
        BlockOfReinforcedIron = new BlockMod(Material.iron, Names.Blocks.BLOCK_OF_REINFORCED_IRON, 3.0f, 10f, "pickaxe", 2);
        BlockOfReinforcedDiamondEncrustedIron = new BlockMod(Material.iron, Names.Blocks.BLOCK_OF_DIAMOND_ENCRUSTED_IRON, 3.5f, 1000000f, "pickaxe", 3);
